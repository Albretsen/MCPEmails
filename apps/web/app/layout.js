...
export const metadata = {
  ...
  ...(GOOGLE_SITE_VERIFICATION
    ...
    : {}),
  title: {
    default: 'Email MCP: Connect Gmail, Outlook & IMAP to Claude | mcpemails',
    template: '%s · mcpemails',
  },
  description: 'Connect Gmail, Outlook, Fastmail, iCloud, or any IMAP email to Claude, Cursor, ChatGPT, and MCP clients. Read, send, search, and organize email live.',
  openGraph: {
    type: 'website',
    siteName: 'mcpemails',
    title: 'Email MCP: Connect Gmail, Outlook & IMAP to Claude | mcpemails',
    description: 'Connect Gmail, Outlook, Fastmail, iCloud, or any IMAP email to Claude, Cursor, ChatGPT, and MCP clients. Read, send, search, and organize email live.',
    url: APP_URL,

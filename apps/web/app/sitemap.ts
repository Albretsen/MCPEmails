...
const MARKETING_PAGES: {
  ...
  { path: '', lastModified: '2026-08-19', changeFrequency: 'weekly', priority: 1.0 },
  { path: '/pricing', lastModified: '2026-07-30', changeFrequency: 'monthly', priority: 0.9 },
  { path: '/docs', lastModified: '2026-08-19', changeFrequency: 'weekly', priority: 0.8 },
  { path: '/docs/providers', lastModified: '2026-08-19', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/native-connectors-vs-mcp', lastModified: '2026-08-19', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/self-hosting', lastModified: '2026-07-09', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/security', lastModified: '2026-08-19', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/for/founders', lastModified: '2026-08-19', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/connect/gmail', lastModified: '2026-08-19', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/connect/fastmail', lastModified: '2026-08-19', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/connect/icloud', lastModified: '2026-08-19', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/connect/yahoo', lastModified: '2026-08-19', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/connect/zoho', lastModified: '2026-08-19', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/connect/yandex', lastModified: '2026-08-19', changeFrequency: 'monthly', priority: 0.6 },

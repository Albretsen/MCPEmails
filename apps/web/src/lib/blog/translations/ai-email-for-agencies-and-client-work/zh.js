const translation = {
  ...
  content: `如果你同时为多个客户打理邮件，就必须守住一条规则：客户 A 的任何内容都不能出现在客户 B 的会话里。AI 智能体不会改变这条规则，只会让它更容易被打破。一个智能体持有一份能触达你所管理的每个邮箱的凭据，离"把错的发票引述给错的人"只差一条随手写下的提示词。
...
可以。Microsoft 365 邮箱通过使用 Microsoft 登录连接，无需应用专用密码。很多组织要求 IT 管理员先为整个组织一次性批准该应用，之后其他人才能连接；控制台会给你一个链接，发给客户的 IT 管理员即可，之后每个邮箱都能正常连接。

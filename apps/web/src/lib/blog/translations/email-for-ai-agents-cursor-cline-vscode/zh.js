...
如果你是从一个 cron 任务或一个紧密的智能体循环来驱动服务器，要留意限制。每个 API 密钥在所有套餐上都被限制为**每分钟 100 次请求、每小时 1,000 次、每天 10,000 次**。在此之上还有一个由你的套餐决定的每工作区突发上限：免费版为 60/min，Pro（$29/month）为 300/min，Team（$79/month）为 1,000/min。完整的细分见[价格页面](/pricing)。

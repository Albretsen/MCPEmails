...
Driver du serveren fra en cron-jobb eller en tett agentløkke, ta hensyn til grensene. Hver API-nøkkel er begrenset til **100 forespørsler per minutt, 1 000 per time og 10 000 per dag**, på alle planer. I tillegg finnes det et burst-tak per arbeidsområde satt av planen din: 60/min på Gratis, 120/min på Personal ($5 per måned), 300/min på Pro ($15 per måned), 1 000/min på Team ($79 per måned). Se [prissiden](/pricing) for hele oversikten.

...
这七件事在[免费方案](/pricing)上都能跑，它是 $0，收件箱不限数量，每个计费周期含 2,500 次可计费操作。免费版允许每分钟 60 个请求；Agent（$12/month）含 50,000 次操作和每分钟 300 个请求；Scale（$49/month）含 300,000 次操作、每分钟 1,000 个请求、团队角色和 SSO。一份每周摘要根本碰不到这些上限；而一个跨多个收件箱、每分钟都跑的激进整理循环，会用到免费版的操作额度，并让你需要 Agent。

...
Gmail og Outlook tilbyr moderne OAuth-API-er, så MCP Emails kobler dem til med en innlogging i stedet for et passord. (En jobb- eller skolekonto i Microsoft 365 kan trenge at en IT-ansvarlig først godkjenner appen én gang; [guiden for Outlook og Microsoft 365](/blog/connect-outlook-microsoft-365-ai-agent-mcp) forklarer det.) iCloud og Fastmail tilbyr ikke den veien til tredjeparts e-postverktøy. I stedet gir de deg et **app-spesifikt passord**: et langt, tilfeldig generert passord som er begrenset til én enkelt applikasjon, atskilt fra det egentlige kontopassordet ditt og som kan tilbakekalles for seg.

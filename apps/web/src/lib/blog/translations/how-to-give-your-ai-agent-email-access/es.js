...
Todo es ilimitado en cada plan: bandejas, llamadas a herramientas, claves de API, miembros del equipo. Los niveles solo difieren en la tasa de ráfaga, la retención de analíticas, las funciones de equipo y el soporte.

- **Free — $0 para siempre.** Sin tarjeta. 60 req/min, analíticas de 7 días, soporte de la comunidad.
- **Solo — $12/month** (o $120/year). 300 req/min, analíticas de 90 días, soporte por correo.
- **Team — $49/month** (o $490/year). 1.000 req/min, roles de equipo y múltiples workspaces, SSO con SAML/OIDC más registro de auditoría, analíticas de 1 año, soporte prioritario.

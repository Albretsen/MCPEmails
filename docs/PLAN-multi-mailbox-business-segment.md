...
| day +13 | `customer-23@redacted.invalid` | `mb@cybercore.cc` | no (grandfathered) |
| day +21 | `customer-13@redacted.invalid` | a second gmail | no (grandfathered) |
| day +23 | `customer-14@redacted.invalid` | `info@titanorelabs.com` | no (grandfathered, 637 actions) |

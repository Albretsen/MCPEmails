...
If the user has no account yet, tell them to sign up at <https://mcpemails.com> and connect an inbox (Gmail, Outlook / Microsoft 365, Fastmail, iCloud, Yahoo, Zoho, Yandex, or any IMAP/SMTP mailbox) before creating the key.
